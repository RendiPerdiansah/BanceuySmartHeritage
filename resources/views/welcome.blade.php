...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="akunDropdown">
        <li><a class="dropdown-item" href="/akun/profile">Lihat Profil</a></li>
        <li><a class="dropdown-item" href="/akun/settings">Pengaturan</a></li>
            ...
            <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        ...
                        <h2 class="text-white-50 mx-auto mt-2 mb-5">Selamat datang di website kampung adat banceuy.</h2>
        ...
        <div class="row gx-4 gx-lg-5">
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card shadow-sm">
                    <img src="https://source.unsplash.com/600x400/?village,nature" class="card-img-top" alt="Pemandangan Kampung">
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card shadow-sm">
                    <img src="https://source.unsplash.com/600x400/?culture,indonesia" class="card-img-top" alt="Tradisi Adat">
                    <div class="card-body">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card shadow-sm">
                    <img src="https://source.unsplash.com/600x400/?nature,indonesia" class="card-img-top" alt="Wisata Alam">
                    <div class="card-body">
