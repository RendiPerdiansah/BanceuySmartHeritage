...
<head>
    ...
    <title>Paket 3 Hari 2 Malam</title>
...
<body class="bg-gray-100 flex items-center justify-center min-h-screen relative">
    ...
    <div class="bg-white p-8 rounded-lg shadow-md max-w-lg w-full">
        <h1 class="text-3xl font-bold mb-4">Paket 3 Hari 2 Malam</h1>
        ...
        <div class="bg-gray-50 p-4 rounded-lg mb-6">
            ...
            <ul class="list-disc list-inside">
                ...
                <li>Belajar Nyawen</li>
                <li>Pentas Seni</li>
                <li>Ngabanceuy</li>
                <li>Ngagobyag</li>
                <li>Magawe dan Tandur</li>
                <li>Makan</li>
        ...
        <p class="mb-6">Mulai dari: <span class="font-bold text-red-600">Rp500.000/Orang</span></p>

        <div class="flex justify-between">
            <a href="/paket_wisata" class="bg-red-500 text-white px-4 py-2 rounded-lg">Kembali</a>
            <button onclick="openModal('Paket 3 Hari 2 Malam')" class="bg-blue-500 text-white px-4 py-2 rounded-lg">Pesan Paket</button>
        </div>
    </div>
